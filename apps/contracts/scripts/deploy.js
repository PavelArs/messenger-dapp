const { createPublicClient, http, parseAbi, createWalletClient, formatEther } = require('viem');
...
async function main() {
  ...
  console.log(`- Transaction hash: ${messenger.deploymentTransaction?.hash || 'N/A'}`);
}
